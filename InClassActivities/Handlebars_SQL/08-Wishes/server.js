...
app.get("/", function(req, res) {
  connection.query("SELECT * FROM christmas_wish;", function(err, data) {
    if (err) throw err;
...
app.post("/", function(req, res) {
  ...
  connection.query("INSERT INTO christmas_wish (wish) VALUES (?)", [req.body.wish], function(err, result) {
    if (err) throw err;
